  ...
  return (
    <div id="experience" className=" container m-auto   mt-16">
      ...
      <div data-aos="fade-up" className="relative mb-5">
        ...
        <a href="https://www.linkedin.com/in/gaganik/details/experience/" target="_blank">Experience</a>
        </h3>
          ...
          >
            <div className=" relative">
              ...
              <div className=" flex flex-col gap-1 border-2 border-cyan-400 shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                ...
                <p className=" text-[.9rem] text-justify text-gray-500">
                <b> Business Vertical: EdTech. </b><br/>
                -> Assisted a development team of 5 engineers, contributing to daily coding tasks, bug fixes, and feature enhancements while gaining experience in software project management and teamwork.<br/>
                -> Supported team collaboration by participating in agile sprints, helping to streamline workflow, and improving code integration processes, leading to a 10% reduction in development time.<br/>
                -> Contributed to the implementation of software solutions, focusing on system optimization and enhancing user experience, which resulted in a 5% improvement in application performance.<br/>
                -> Worked closely with senior developers and industry experts, gathering technical insights to help refine development processes and apply best coding practices.<br/>
                -> Helped meet project deadlines by supporting code testing, documentation, and deployment, contributing to smoother releases and improving delivery speed by 10%.<br/>
                </p>
              </div>
            </div>
          </fieldset>
